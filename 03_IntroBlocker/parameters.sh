...
fasta_index_file="/filer-dg/agruppen/dg6/fengj/hbulbosum_genome/Introblocker/FB19_011_3_pseudomolecules_v6_hap1.fasta.fai"

# chromosomes to analyze
chr_list_file="/filer-dg/agruppen/dg6/fengj/hbulbosum_genome/Introblocker/all_5M/chr_list.txt"

# the absolute path of the working directory
working_dir="/filer-dg/agruppen/dg6/fengj/hbulbosum_genome/Introblocker/all_5M"

# the absolute path of the IntroBlocker software directory
script_dir="/filer-dg/agruppen/dg6/fengj/hbulbosum_genome/Introblocker/all_5M"
...
taxa_bam_file="/filer-dg/agruppen/dg6/fengj/hbulbosum_genome/Introblocker/all_5M/taxa_bam.txt"

# the chr_vcf_file file contains absolte paths of vcf files of each chromosome
chr_vcf_file="/filer-dg/agruppen/dg6/fengj/hbulbosum_genome/Introblocker/all_5M/chr_vcf.txt"

# the taxa_order_file file specifies the group of each taxa
taxa_order_file="/filer-dg/agruppen/dg6/fengj/hbulbosum_genome/Introblocker/all_5M/taxa_order.txt"
